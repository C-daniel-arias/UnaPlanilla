package cr.ac.una.plantillaproyectos.util;
...
import cr.ac.una.plantillaproyectos.controller.Controller;
...
public class FlowController {
    ...
    public void goViewInWindow(String viewName) {
        ...
        stage.getIcons().add(new Image("cr/ac/una/plantillaproyectos/resources/LogoUNArojo.png"));
