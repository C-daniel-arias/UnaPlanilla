...
public class Salario implements Serializable {
    ...
    private Empleado_Consultas salEmpid;
    ...
    public Empleado_Consultas getSalEmpid() {
        return salEmpid;
    }

    public void setSalEmpid(Empleado_Consultas salEmpid) {
    ...
    public String toString() {
        return "cr.ac.una.plantillaproyectos.model.Salario[ id=" + id + " ]";
    }
